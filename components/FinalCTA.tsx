  ...
  return (
    <section style={{ position: "relative", height: "100vh", display: "flex", alignItems: "center", justifyContent: "center", background: "var(--background)", overflow: "hidden" }}>
      ...
      <div style={{ position: "relative", zIndex: 10, textAlign: "center", padding: "0 5vw" }}>
        <h2 className="neon-glow" style={{ fontFamily: "var(--font-display)", fontSize: "clamp(6rem, 15vw, 16rem)", color: "var(--electric)", lineHeight: 0.8, marginBottom: "2rem" }}>
          START<br />TODAY
        </h2>
      ...
      <div style={{ position: "absolute", bottom: "2rem", width: "100%", display: "flex", justifyContent: "center", gap: "3rem", zIndex: 10 }}>
